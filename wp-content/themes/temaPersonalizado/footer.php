               ...
               <ul class="social">
                  <li>
                     <a class="icon fa-facebook" 
                        href="https://www.facebook.com/MiApartamento60/" target="_blank" aria-label="Síguenos en Facebook"
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 224 432">
                           <path fill="#F2F6F7" d="M145 429H66V235H0v-76h66v-56q0-48 27-74t72-26q36 0 59 3v67l-41 1q-22 0-30 9t-8 27v49h76l-10 76h-66v194z"/>
                        </svg>
                        <span class="label">Facebook</span>
                     </a>
                  </li>
                  <li>
                     <a class="icon fa-airbnb" 
                        href="https://www.airbnb.es/rooms/24676441?source_impression_id=p3_1769858561_P3rE4xqksyH17uvr" 
                        target="_blank" aria-label="Ver en Airbnb"
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 256 275">
